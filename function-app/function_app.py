...
def my_orchestrator(context: df.DurableOrchestrationContext):
    ...
    # 3. If invalid, return status and reason
    ...
    # 5. Return completed status and the url
...
def report_activity(order: dict) -> str:
    ...
    # Create the container group with the Attached Identity
    ...
    account_url = os.environ["STORAGE_ACCOUNT_URL"].rstrip("/")
    return f"{account_url}/reports/{order_id}.pdf"